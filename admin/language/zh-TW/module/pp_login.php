<?php
// Heading
$_['heading_title']        = '用 PayPal 帳戶名登入';

//Text
$_['text_module']          = '模組管理';
$_['text_success']         = '成功：您已修改用 PayPal 帳戶名登入！';
...
$_['entry_button']         = '按鈕顏色';
$_['entry_seamless']       = '允許「Seamless Checkout」';
...
$_['error_client_id']      = 'Client ID 必須輸入 !';
$_['error_secret']         = '密鑰必須輸入 !';